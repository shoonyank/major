...
function backtopavillion(){
	header('Location: http://localhost/Major%20Project/Online%20Exam%20Portal/discussion_forum/yourquestion.php');
	exit;
}
...
function getpageno($shown_to){
	include 'dbconnect.php';
	$query="Select max(page) from questions where shown_to='".$shown_to."'";
