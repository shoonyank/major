...
<!--Login Form-->
<form action="database/teacher_login.php" method="POST" style="margin-left: 0%;margin-right: 0%;margin-top: 2%;margin-bottom: 2%;">
<legend style="color:white">Faculty Login</legend>
